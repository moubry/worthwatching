...
import com.moubry.worthwatching.MovieListAdapter;
...
import com.moubry.worthwatching.MovieListsAsyncTask;
...
public class HomeActivity extends LicenseCheckActivity {
	...
	public void onCreate(Bundle savedInstanceState) {
        ...
        getListView().setOnItemClickListener(new ListView.OnItemClickListener() {
            public void onItemClick(AdapterView<?> parent, View v, int position, long id) {
                ...
                com.moubry.worthwatching.api.List list = (com.moubry.worthwatching.api.List) parent.getItemAtPosition(position);

                Intent anotherActivityIntent = new Intent(v.getContext(), MovieListActivity.class);
                
                anotherActivityIntent.putExtra("com.moubry.listid", list.ListID);
...
//        showWhatsNewIfEnabled();
    ...
    public void onDestroy() {
	    ...
	    protected void onResume() {
	        ...
	        if ((this.m_cachedResult = this.getMovieListFromCache(this.m_cachedResult, listName)) != null) {
	            bindDataToList(m_cachedResult, false, null);
	        } else {
	            MovieListsAsyncTask task = new MovieListsAsyncTask(this, listName, new MovieListCallback() {
	                
	                @Override
	                public void HandleJsonResult(String json, String errorMessage) {
	                    HomeActivity.this.bindDataToList(json, true, errorMessage);
	                }
	            });
	    ...
	    public String listName = "PopularLists";

	    public void bindDataToList(String jsonResult, boolean isNew, String errorMessage) {
	        boolean isValid = true;
	        List<com.moubry.worthwatching.api.List> lstPopularLists = new ArrayList<com.moubry.worthwatching.api.List>();
	        ...
	        if (errorMessage != null) {
	            ...
	            getListView().setAdapter(new MovieListAdapter(this, R.layout.list_list_item, lstPopularLists));
	        ...
	        try {
	            ...
	            for (int i = 0; i < array.size(); i++) {
	                lstPopularLists.add(new Gson().fromJson(array.get(i), com.moubry.worthwatching.api.List.class));
	            }
	        } catch (Exception e) {
	        ...
	        if (isValid) {
	            ...
	            if (isNew)
	                addMovieListToDb(listName, jsonResult);
	        }
